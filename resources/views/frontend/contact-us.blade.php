                ...
                <div class="col-lg-6">
                    <form action="{{ route('contact_us.store') }}" method="post" data-handler="settingCommonHandler">
                        ...
                        <div class="pb-21">
                            <div class="primary-form-group">
                                <div class="primary-form-group-wrap">
                                    <label for="csName" class="form-label">{{ __('Your Name') }}</label>
                        ...
                        <div class="pb-21">
                            <div class="primary-form-group">
                                <div class="primary-form-group-wrap">
                                    <label for="csEmail" class="form-label">{{ __('Your Email') }}</label>
                        ...
                        <div class="pb-21">
                            <div class="primary-form-group">
                                <div class="primary-form-group-wrap">
                                    <label for="csMessage" class="form-label">{{ __('Your Message') }}</label>
