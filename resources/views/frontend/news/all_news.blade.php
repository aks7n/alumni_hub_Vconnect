                ...
                <div class="col-lg-4 col-md-6">
                    <div class="hover-scale-img bd-one bd-c-black-10 bd-ra-25 bg-event-bg">
                        <div class="bd-ra-14 overflow-hidden h-234 position-relative">
                            ...
                            <p class="frontendNews position-absolute top-22 left-22 p-10 bd-ra-10 bg-primary-color max-w-77 fs-16 fw-400 lh-19 text-black-color text-center">{{ date('M d, Y', strtotime($news->created_at)) }}</p>
                        </div>
