<head>
    ...
    <link rel="stylesheet" href="{{ asset('super_admin/css/plugins.css?v=1') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('super_admin/scss/style.css?v=1') }}" />
    <link rel="stylesheet" href="{{ asset('super_admin/css/responsive.css?v=1') }}" />
