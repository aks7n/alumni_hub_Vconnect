    ...
    <div class="zSidebar-fixed">
        <ul class="zSidebar-menu" id="sidebarMenu">
                       ...
                       class="d-flex align-items-center cg-10 {{$activeSubscriptionIndex ?? ''}}">
                        <div class="d-flex  {{ isset($activeSubscriptionIndex) ? 'active' : 'collapsed' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24"
                                ...
                                <path d="M5.31836 9.00012H8.31836" stroke="white" stroke-opacity="0.7"
                                      stroke-width="1.5" stroke-linecap="round"/>
                                <path d="M16.3184 15.0001H19.3184" stroke="white" stroke-opacity="0.7"
                                      stroke-width="1.5" stroke-linecap="round"/>
            ...
            @if(isAddonInstalled('ALUSAAS'))
                ...
                @if(getCustomerAddonBuildVersion('ALUSAAS') >= 4)
                    <li>
                        ...
                        <div class="collapse {{ $showNewsSubscriptionLetter ?? '' }}" id="subscriptionNewsLetter"
                             data-bs-parent="#sidebarMenu">
                            <ul class="zSidebar-submenu">
                                <li><a class="{{ $activeSubscriptionLetterEmail ?? '' }}"
                                       href="{{ route('saas.super_admin.news-subscription-letter-email.list') }}">{{ __('Subscriber Email') }}</a>
                                </li>
                                <li><a class="{{ $activeEmailTemplateSubscription ?? '' }}"
                                       href="{{ route('saas.super_admin.subscription-email-template.list') }}">{{ __('Email Template') }}</a>
                                </li>
                                <li><a class="{{ $activeEmailTemplateSubscriptionSendMail ?? '' }}"
                                       href="{{ route('saas.super_admin.subscription-email-template.send-mail-list') }}">{{ __('Send Mail') }}</a>
                                </li>
                            </ul>
                        </div>
                    </li>
